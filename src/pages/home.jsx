            ...
            <div className="blogs content backdrop-blur-xl">
              ...
              <div className="part5 flex flex-col p-4">
                <div className="flex items-center gap-1 mb-1 ml-3">
                  <svg onClick={() => toggleLike(blog._id)} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className={`mr-2 cursor-pointer ${isLiked ? ' text-red-600' : 'text-white'}`} height="22" width="22" xmlns="http://www.w3.org/2000/svg">
